...
```json
{"name":"service-from-template-1633531321399","status":"OK","version":"0.1.0"}
```
...
```shell
docker pull nexus.mia-platform.eu/console/test-e2e/test-services/service-from-template-1633531321399:latest
set -a
source .env
docker run --name service-from-template-1633531321399 \
  ...
  -p 3000:3000 \
  --detach \
  nexus.mia-platform.eu/console/test-e2e/test-services/service-from-template-1633531321399
```

[nvm]: https://github.com/creationix/nvm
[merge-request]: https://github.com/mia-platform-playground/service-from-template-1633531321399/merge_requests
